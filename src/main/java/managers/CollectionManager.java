...
public class CollectionManager {
    ...
    public Worker workerForReplacement(long id) throws ExitException {
        ...
        return new Worker(id, newName, newCoordinates, workerMap.get(id).getCreationDate(), newSalary, newStartDate, newPosition,
                newStatus, newOrganization);
    }

    public Worker freshWorker(long key) throws ExitException {
        Scanner scanner = new Scanner(System.in);
        String newName;
        double newX;
        double newY;
